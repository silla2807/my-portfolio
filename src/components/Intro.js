        ...
        <div
          ...
          <div className="flex space-x-4">
            <button
              ...
              className="border-2 border-blue-500 text-center text-sm text-white-900 font-semibold py-2 px-4 rounded-full shadow  hover:scale-105 transform transition duration-300"
            >
              Let’s Connect
            </button>
            <a
